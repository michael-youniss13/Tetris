...
public class S extends GameObjects {
	...
	public void updateGameArray() {
		TetrisFrame.gameField[super.square1.pos_x / 20][super.square1.pos_y / 20] = 7;
		TetrisFrame.gameField[super.square2.pos_x / 20][super.square2.pos_y / 20] = 7;
		TetrisFrame.gameField[super.square3.pos_x / 20][super.square3.pos_y / 20] = 7;
		TetrisFrame.gameField[super.square4.pos_x / 20][super.square4.pos_y / 20] = 7;
	}
		...
		if (canRotate()) {
			if (rotate == 0) {
				...
				super.square4.translatePosition(super.square4.pos_x,
						super.square4.pos_y - 2 * Square.square_Length);
				rotate = 1;
			} else {
				super.square2.translatePosition(super.square2.pos_x
						+ Square.square_Length, super.square2.pos_y

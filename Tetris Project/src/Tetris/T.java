...
public class T extends GameObjects {
	...
	public void updateGameArray() {
		TetrisFrame.gameField[super.square1.pos_x / 20][super.square1.pos_y / 20] = 1;
		TetrisFrame.gameField[super.square2.pos_x / 20][super.square2.pos_y / 20] = 1;
		TetrisFrame.gameField[super.square3.pos_x / 20][super.square3.pos_y / 20] = 1;
		TetrisFrame.gameField[super.square4.pos_x / 20][super.square4.pos_y / 20] = 1;
	}
